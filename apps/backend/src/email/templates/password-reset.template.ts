...
export function passwordResetTemplate(userEmail: string, resetUrl: string): string {
  const content = `
    ...
    <p style="margin:0 0 24px;font-size:14px;color:#64748b;line-height:1.6;">
      We received a request for <strong style="color:#1e1b4b;">${userEmail}</strong>.
    ...
    <p style="margin:20px 0 0;font-size:12px;color:#94a3b8;line-height:1.6;">
      ...
      <a href="${resetUrl}" style="color:#6366f1;text-decoration:none;word-break:break-all;font-size:11px;">
        ${resetUrl}
      </a>
    </p>
