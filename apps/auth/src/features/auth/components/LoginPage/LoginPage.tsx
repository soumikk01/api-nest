      ...
      <main className={styles.main}>
        <div className={styles.card}>
          ...
          <div className={styles.oauthRow}>
            <button type="button" className={styles.oauthBtn} aria-label="Sign in with Google" disabled title="Coming soon"
            >
            ...
            <button type="button" className={styles.oauthBtn} aria-label="Sign in with GitHub" disabled title="Coming soon"
            >
