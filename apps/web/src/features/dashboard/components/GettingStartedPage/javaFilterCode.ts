...
export const JAVA_FILTER_CODE = [
  ...
  '',
  '    @Value("${APINEST_SDK_TOKEN:}") private String sdkToken;',
  '    @Value("${APINEST_BACKEND_URL:http://localhost:4000}") private String backendUrl;',
  ...
  '            System.out.println("[api-monitor] APINEST_SDK_TOKEN not set — disabled"); return;',
  '        }',
