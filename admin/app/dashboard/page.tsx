    ...
    <>
      <div className="page-header">
        <div>
          ...
          <div className="page-subtitle">Real-time summary of all API Monitor activity</div>
        </div>
          ...
          {recent.length === 0 ? (
            <div className="empty-state">
              ...
              <div className="empty-desc">
                Run <code style={{ fontFamily: 'var(--font-mono)', background: 'var(--surface-2)', padding: '2px 6px', borderRadius: '4px' }}>npx api-monitor-cli init --token …</code> in your dev project to start monitoring
              </div>
            </div>
          ) : (
